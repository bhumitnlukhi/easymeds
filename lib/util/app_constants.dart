...
class AppConstants {
  static const String appName = 'Easymeds';
  ...
  static const String webHostedUrl = 'https://easymeds.in/cms';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://easymeds.in/cms';
  ...
  // order check
  static const String orderCheckUri = '/api/v1/customer/order/check';


  // Career

  static const String careerApplyUri = "/api/v1/careerStore";
  static const String jobRoleListUri = "/api/v1/getJobRoles";
