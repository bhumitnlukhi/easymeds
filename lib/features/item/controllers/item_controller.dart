...
class ItemController extends GetxController implements GetxService {
  ...
  bool _isUsesReadMore = false;
  bool get isUsesReadMore => _isUsesReadMore;

  bool _isDirectionReadMore = false;
  bool get isDirectionReadMore => _isDirectionReadMore;
  ...
  void changeUsesReadMore() {
    _isUsesReadMore = !_isUsesReadMore;
    update();
  }

  void changeDirectionUseReadMore() {
    _isDirectionReadMore = !_isDirectionReadMore;
    update();
  }
